...
const create = async (req, res) => {
  // #swagger.tags = ['AdminAdministrator']
  /*
  ...
  */
  try{
      const admin = await ThisModel.findOne({where:{user_id:req.user.userId}});
      ...
      req.body['list_of_companies'] = admin.list_of_companies;
...
const list = async (req, res) => {
    ...
    try {
        ...
        const admin = await ThisModel.findOne({where:{user_id:req.user.userId}});
        query['where']['list_of_companies'] = admin.list_of_companies;
